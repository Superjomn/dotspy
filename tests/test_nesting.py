import pytest
from dotspy import Graph, Subgraph, Node
from dotspy.constants import DIGRAPH
...
def test_nested_subgraphs():
    ...
    assert len(g._subgraphs) == 1, f"Graph should have 1 top-level subgraph, found {len(g._subgraphs)}"
