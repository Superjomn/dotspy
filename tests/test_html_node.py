...
import tempfile
import os
from dotspy import HTMLNode, Graph
...
class TestHTMLNodeBasic:
    ...
    def test_html_node_requires_one_parameter(self):
        ...
        with pytest.raises(ValueError, match="Must specify either 'markdown' or 'html'"):
            HTMLNode(name="test")
    
    def test_html_node_rejects_both_parameters(self):
        """Test that HTMLNode rejects both markdown and html."""
        with pytest.raises(ValueError, match="Specify either 'markdown' or 'html', not both"):
