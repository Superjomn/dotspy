...
_current_subgraph: ContextVar[Optional["Subgraph"]] = ContextVar(
    "current_subgraph", default=None
)
_active_node_styles: ContextVar[List["NodeStyle"]] = ContextVar(
    "active_node_styles", default=[]
)
